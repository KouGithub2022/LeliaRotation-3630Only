...
public sealed class BRDPvE_Default : BRD_Base
{
    ...
    protected override IRotationConfigSet CreateConfiguration() => base.CreateConfiguration()
            ...
            .SetCombo(CombatType.PvE, @"First Song""", 0, @"First Song""", @"Wanderer's Minuet""", @"Mage's Ballad""", @"Army's Paeon""")
    ...
    private float WANDRemainTime => 43 - Configs.GetFloat(@"WANDTime""");
    private float MAGERemainTime => 34 - Configs.GetFloat(@"MAGETime""");
    private float ARMYRemainTime => 43 - Configs.GetFloat(@"ARMYTime""");
    ...
    protected override bool AttackAbility(out IAction act)
    {
        ...
        if (ArmysPaeon.CanUse(out act))
        {
            ...
            //return false;
            //if (Player.Level > 51 && SongEndAfter(MAGERemainTime) && Song == Song.MAGE) return true;
            //if (Player.Level > 51 && SongEndAfter(2) && MagesBallad.IsCoolingDown && Song == Song.WANDERER) return true;
            //if (Player.Level < 52 && SongEndAfter(2)) return true;
