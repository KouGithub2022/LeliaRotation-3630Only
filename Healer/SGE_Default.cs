...
public sealed class SGEPvE_Default : SGE_Base
{
    public override CombatType Type => CombatType.PvE;

    public override string GameVersion => "6.38";

    public override string RotationName => "Lelia Default(PvE)";
    ...
    protected override bool DefenseAreaGCD(out IAction act)
    {
        ...
        {
            if (EukrasianDiagnosis.Target.HasStatus(false,StatusID.EukrasianDiagnosis,StatusID.EukrasianPrognosis,StatusID.Galvanize)) return false;
            if (Eukrasia.CanUse(out act)) return true;
    ...
    protected override bool GeneralGCD(out IAction act)
    {
        ...
        if (IsMoving && Dyskrasia.CanUse(out act, CanUseOption.MustUse)) return true;
