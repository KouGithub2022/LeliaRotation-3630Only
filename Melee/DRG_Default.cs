...
public sealed class DRGPvE_Default : DRG_Base
{
    ...
    protected override bool AttackAbility(out IAction act)
    {
        if (IsBurst)
        {
			if (InCombat && LifeSurge.CanUse(out act, CanUseOption.MustUse)) return true;
		...
		if (LifeSurge.CanUse(out act, CanUseOption.MustUse)) return true;
